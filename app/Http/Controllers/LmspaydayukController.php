...
class LmspaydayukController extends Controller
{
    /** CRUD's */
    ...
    public function index()
    {
        ...
        $leads = DB::table('lmspaydayuks')->get();

        // load the view and pass the leads
        return View::make('admin.leads-uk')
            ->with('leads', $leads); // TODO -> leads
//        return view('admin.partner-list');
    ...
    public function edit($id)
    {
        ...
        return View::make('admin.leads-edit')
            ->with('leads.edit', $leads);
    }
