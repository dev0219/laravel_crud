  ...
  <nav
    ...
    <div class="nav-wrapper">
      ...
      <ul class="dropdown-content" id="translation-dropdown">
        ...
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="{{url('lang/en')}}" data-language="fr">
            <i class="flag-icon flag-icon-fr"></i>
            French
          </a>
        </li>
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="{{url('lang/en')}}" data-language="pt">
            <i class="flag-icon flag-icon-pt"></i>
            Portuguese
          </a>
        </li>
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="{{url('lang/en')}}" data-language="de">
      ...
      <ul class="dropdown-content" id="notifications-dropdown">
        ...
        <li>
          <a class="black-text" href="javascript:void(0)">
            ...
            Weekly Commission has been paid
          </a>
...
{{--// {{ route('user.profile', Auth::user()->id) }}--}}
        ...
        <li class="divider"></li>
        <li>
          <a class="grey-text text-darken-1" href="{{asset('lock-screen')}}">
