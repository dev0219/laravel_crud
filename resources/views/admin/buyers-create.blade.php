                            ...
                            <div class="row">
                                <div class="col s12 m6">
                                    <div class="row">
                                        ...
                                        <div class="col s12 input-field">
                                            <input id="email" name="email" type="email" class="validate" value="johndoe@gmail.com"
                                                   data-error=".errorTxt3">
                                            <label for="email">E-mail</label>
                                            <small class="errorTxt3"></small>
                                        </div>
                                        <div class="col s12 input-field">
                                            <input id="phone" name="phone" type="text" class="validate" value="01234 566789"
                                                   data-error=".errorTxt3">
                                            <label for="phone">Phone</label>
                                            <small class="errorTxt3"></small>
                                        </div>
                                        <div class="col s12 input-field">
                                            <input id="company" name="company" type="text" class="validate" value="XYZ Limited"
                                                   data-error=".errorTxt3">
                                            <label for="company">Company</label>
                                            <small class="errorTxt3"></small>
                                        </div>
                                        <div class="col s12 input-field">
                                            <input id="address" name="address" type="text" class="validate" value="130 Old Street"
                                                   data-error=".errorTxt3">
                                            <label for="address">Address</label>
                                            <small class="errorTxt3"></small>
                                        </div>
                                        <div class="col s12 input-field">
                                            <input id="city" name="city" type="text" class="validate" value="London"
                                                   data-error=".errorTxt3">
