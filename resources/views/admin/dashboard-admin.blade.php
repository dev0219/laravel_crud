...
@section('content')
    <div class="section">
                    ...
                    <div class="card gradient-45deg-amber-amber gradient-shadow min-height-100 white-text animate fadeRight">
                        <div class="padding-4">
                            <div class="row">
                                ...
                                <div class="col s5 m5 right-align">
                                    <h5 class="mb-0 white-text">90%</h5>
                    ...
                    <div class="card gradient-45deg-green-teal gradient-shadow min-height-100 white-text animate fadeRight">
                        <div class="padding-4">
                            <div class="row">
                                ...
                                <div class="col s5 m5 right-align">
                                    <h5 class="mb-0 white-text">£2,500</h5>
                                    <p class="no-margin">Week</p>
                                    <p>£2,500</p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Member online, Current Server load & Today's Revenue Chart start -->
                ...
                <div class="col s12 m4 l4">
                    <div class="card pt-0 pb-0 animate fadeLeft">
                        <div class="dashboard-revenue-wrapper padding-2 ml-2">
                            ...
                            <p class="mt-2 mb-0">Partner Activity</p>
                ...
                <div class="col s12 m4 l4 animate fadeUp">
                    <div class="card pt-0 pb-0">
                        <div class="dashboard-revenue-wrapper padding-2 ml-2">
                            ...
                            <p class="mt-2 mb-0">Buyer Activity</p>
