...
{{--        <a href="{{asset('partners/edit/{$id}')}}" class="btn-small indigo">Edit</a>--}}
      </div>
    </div>
  </div>
        ...
        <div class="col s12 m4">
          <table class="striped">
            <tbody>
              ...
              <tr>
                <td>Role:</td>
                <td class="users-view-role">Partner</td>
              </tr>
              <tr>
                <td>Status:</td>
        ...
        <div class="col s12">
          <table class="striped">
            <tbody>
              <tr>
                <td>Email:</td>
                <td class="users-view-username">johndoe@gmail.com</td>
              </tr>
              <tr>
                <td>Name:</td>
              ...
              <tr>
                <td>Company:</td>
                <td class="users-view-company">XYZ Ltd.</td>
              </tr>
              <tr>
                <td>Address:</td>
                <td class="users-view-address">130 Old Street</td>
              </tr>
              <tr>
                <td>City:</td>
                <td class="users-view-city">London</td>
              </tr>
              <tr>
                <td>State:</td>
                <td class="users-view-state">London</td>
              </tr>
              <tr>
                <td>Postcode:</td>
                <td class="users-view-postcode">EC1V 9BD</td>
              </tr>
              <tr>
                <td>Country:</td>
