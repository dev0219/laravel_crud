            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="responsive-table">
                        <table id="users-list-datatable" class="table">
                            ...
                            <tr>
                                <td></td>
                                <td>300</td>
                                <td><a href="{{asset('offers/view/{$id}')}}">dean3004</a>
                                </td>
                                <td>Dean Stanley</td>
                                <td>30/04/2019</td>
                                <td>No</td>
                    ...
                    <span class="green-text">Active</span>
                                ...
                                <td><a href="{{asset('offers/view/{$id}')}}"><i class="material-icons">edit</i></a></td>
                                <td><a href="{{asset('offers/view/{$id}')}}"><i class="material-icons">remove_red_eye</i></a></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>301</td>
