    ...
    <div class="row">
        ...
        <div class="col s12 l4">
            ...
            <div class="card recent-buyers-card animate fadeUp">
                <div class="card-content">
                    <h4 class="card-title mb-0">Top Trending Buyers <i class="material-icons float-right">more_vert</i></h4>
            ...
            <div class="card padding-4 animate fadeLeft">
                <div class="row">
                    <div class="col s5 m5">
                        ...
                        <p class="no-margin">Purchased Leads</p>
            ...
            <div class="card subscriber-list-card animate fadeRight">
                ...
                <table class="subscription-table responsive-table highlight">
                    ...
                    <tr>
                        ...
                        <td>amikaro Finance LTD.</td>
                        <td>Jan 1,2019</td>
                        <td><span class="badge pink lighten-5 pink-text text-accent-2">Decline</span></td>
                        <td>£ 1000.00</td>
                        <td class="center-align"><a href="#"><i class="material-icons pink-text">view</i></a></td>
                    </tr>
                    <tr>
                        <td>Aldin Rakić</td>
                        <td>amikaro Finance LTD.</td>
                        <td>Jan 10,2019</td>
                        <td><span class="badge green lighten-5 green-text text-accent-4">Sold</span></td>
                        <td>£ 3000.00</td>
                        <td class="center-align"><a href="#"><i class="material-icons pink-text">view</i></a></td>
                    </tr>
                    <tr>
