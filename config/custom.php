...
return [
    'custom' => [
        ...
        'navbarBgColor' => '', //Options: cyan,teal,light-blue,amber (any of materialize color class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuColor' => '', //Sidebar active menu color (any of materialize color class can be pass)
        ...
        'largeScreenLogo' => 'images/logo/materialize-logo-big.png', //we used separate log image for large screen and small
        'smallScreenLogo' => 'images/logo/materialize-logo-color.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
